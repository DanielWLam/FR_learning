...
var match = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash__["curry"])((reg, str) => str.match(reg));
var filter = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_lodash__["curry"])((f, arr) => arr.filter(f));
